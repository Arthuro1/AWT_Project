...
import PersonsCard from './personCard';
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 pl-2 pl-lg-5">
                            ...
                            <p>
                                ...
                                interesting name, isn’t it? Before talking about this name, let's just begin with us.
                                From the left to right, that’s
                                <b><i> Shahrzad Amini</i></b>, <b><i> Paul Meteng</i></b>, <b><i> Meijie
                                Li</i></b> and <b><i> Vidhya Vijayaraman</i></b>.
                                Just years ago, we all lived in different countries, that’s
                                Iran, Kamerun, China and Indien.
                            </p>
                            <p>
                                A few years ago, we all lived in different countries which are respectively in Iran,
                                Cameroon, China and India. But now we are in the same group and have finished this
                                project together, that’s really amazing.
                                How could that come true? That just because we took part in an amazing
                                course <b><i> Advanced Web Technology </i></b> together! Yes, we are all the student
                                from
                                Duisburg-Essen university and we learn Computer Engineering. And this website was the
                            ...
                            <p className="mb-5">
                                ...
                                In fact students can easily find the most recommended books for a particular subject
                                based on the rating and comments of others. They can also rate and comment the books for
                                others.
                            </p>
                            <p>
                                Finally, let's come back to the meaning of our interesting group name <b><i>#-GROUP</i></b>.
                                But why actually <b><i> ‘#’</i></b>? That is just because during the preparation of the
                                React
                                hands-on session and lecture one of our group member, while copying some code from
                                internet accidentally copied a #. It is only later we realised that the hash didn't have
                                any meaning in the code. At that time we had already pasted it in multiple places in our
                                code.
                                It is from this hilarious situation that the name of our group came from, remembering us
                                actually what copy-paste can cause.
                            </p>
                        </div>
                    </div>
                </div>
